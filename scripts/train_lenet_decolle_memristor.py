...
# Licence : GPLv2
#-----------------------------------------------------------------------------
from decolle.lenet_decolle_model_memristor import LenetDECOLLEMemristor, DECOLLELoss, LIFLayerVariableTau, LIFLayer
...
net = LenetDECOLLEMemristor( out_channels=params['out_channels'],
                    Nhid=params['Nhid'],
                    Mhid=params['Mhid'],
